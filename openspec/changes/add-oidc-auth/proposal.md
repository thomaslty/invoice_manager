...
- **Frontend code**: New `AuthProvider` context, `NavUser` component. Modified `App.jsx`, `Sidebar.jsx`, `api.js`, `FontCard.jsx` (use `canDelete` flag). New shadcn `avatar` component.
